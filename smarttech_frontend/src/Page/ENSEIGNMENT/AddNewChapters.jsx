        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          <div className="form-group" >
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label={`${t('SelectFormation')}:`}  variant="outlined" />
              )}
            />
          ...
          <div className="form-group">
          <input name="titleEn" value={newChapter.titleEn} onChange={handleChange} placeholder="Title in english" required />
          </div>
          <div className="form-group">
          <input name="titleFr" value={newChapter.titleFr} onChange={handleChange} placeholder="Titre en français" />
          </div>
          <div className="form-group">
          <input name="titleAr" value={newChapter.titleAr} onChange={handleChange} placeholder="العنوان باللغة العربية" />
          </div>
          <div className="form-group">
          <input name="descriptionEn" value={newChapter.descriptionEn} onChange={handleChange} placeholder="Description in english" />
          </div>
          <div className="form-group">
          <input name="descriptionFr" value={newChapter.descriptionFr} onChange={handleChange} placeholder="Description en français" />
          </div>
          <div className="form-group">
          <input name="descriptionAr" value={newChapter.descriptionAr} onChange={handleChange} placeholder="الوصف باللغة العربية" />
          </div>
          <div className="form-group">
          <input name="price" value={newChapter.price} onChange={handleChange} placeholder={t('Price')} type="number" />
          </div>
          <div className="form-group">
           ...
           />
            ...
            <br />
            <div className="form-group">
            <input onChange={pdfCoursHandler} type="file"  accept="application/pdf"   name="pdfCours" placeholder={t('Typehere')} />
            </div>
            <div className="form-group">
            <input  onChange={pdfTDHandler} accept="application/pdf" type="file" name="pdfTD"  placeholder={t('Typehere')} />
            </div>
          </div>
