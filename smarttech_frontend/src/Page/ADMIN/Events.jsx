    ...
    <div className="p-4 sm:ml-64 font-[Montserrat] bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow-md rounded-2xl p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">{t('Event Calendar')}</h2>
          <Calendar
          ...
          <div className="mt-4">
            <h3 className="text-lg font-semibold mb-2">
              {t('Events on')} {formatDate(selectedDate)}
            </h3>
            <div className="max-h-60 overflow-y-auto">
              {getEventsForDate(selectedDate).length > 0 ? (
                ...
                <p className="text-gray-500">{t('No events scheduled')}</p>
              )}
            </div>
          </div>
        </div>
        ...
        {/* Event Creation Form */}
        <div className="bg-white shadow-md rounded-2xl p-6">
          <h2 className="text-xl font-semibold text-blue-800 mb-4">{t('CreationEvents')}</h2>
              ...
              {event.length > 0 ? (
                ...
                <tr>
                  <td colSpan="4" className="px-4 py-8 text-center">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-500">{t('No events found')}</h3>
                  </td>
                </tr>
              )}
            </tbody>
